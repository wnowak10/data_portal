...
function load_page(){
    ...
    d3.csv('tiles.csv', function(data) {
        data.forEach(function(d) {
            console.log('true or false', d['display_as_percent_increase_since'])
            load_tile(data_file_path = DATA_PATH + d['id'] +'.json',
                      tile_title = d['tile_title'],
                      id = d['id'],
                      source = d['source'],
                      units = d['units'],
                      display_as_percent_increase_since = d['display_as_percent_increase_since'],
                      base_date_of_percent_increase = +d['base_date_of_percent_increase']);
        });
    });
